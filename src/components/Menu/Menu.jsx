...
export const category = [
  ...
  },
  {
    ...
    arr: [
      ...
      { name: "Носки" },
      { name: "Галстуки" },
      { name: "Картхолдеры с RFID и чехлы для карт" },
      { name: "Обложки для документов" },
      { name: "Портмоне и кошельки" },
      { name: "Солнцезащитные очки и чехлы для очков" },
      { name: "Часы наручные" },
      { name: "Ключницы" },
      { name: "Косметички" },
      { name: "Дорожные органайзеры и тревел-портмоне" },
      { name: "Платки" },
  ...
  },
  {
    name: "Электроника",
    arr: [
      { name: "Аккумуляторы (Power Bank)" },
      { name: "Для мобильных устройств",
        arr: [
          { name: "Аксессуары для мобильных устройств" },
      ...
      { name: "Камеры и аксессуары для съемки" },
    ],
  },
  {
    name: "Дом",
  ...
  },
  {
    ...
    arr: [
      ...
      { name: "Снеки, орехи, сухофрукты" },
      { name: "Шоколад, конфеты, печенье" },
  ...
  },
  {
    ...
    arr: [
      { name: "Лейблы и шильды" },
      { name: "Ремувки и пуллеры" },
      { name: "Шевроны и стикеры" },
      { name: "Фурнитура" },
      { name: "Ленты и шнуры" },
    ],
  },
